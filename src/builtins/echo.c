...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/27 12:55:28 by ssalorin          #+#    #+#             */
/*   Updated: 2025/03/27 12:55:30 by ssalorin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Checks if a given argument is a valid `-n` flag for the `echo` 
 *        command.
 * 
 * A valid `-n` flag starts with `-n` and contains only `n` characters 
 * after the `-`. If the argument does not match this pattern, it is 
 * considered invalid.
 * 
 ...
 * @param i A pointer to the argument index, which is incremented past 
 *          `-n` flags.
 * 
 ...
 * 
 * This function prints the given arguments to standard output, handling the 
 * `-n` flag (which suppresses the trailing newline). If no arguments are 
 * provided, it prints a newline by default.
 * 
 * @param args A NULL-terminated array of command arguments.
